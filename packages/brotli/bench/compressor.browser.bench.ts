...
beforeAll(async () => {
  await init();
  hugeSvg = new Uint8Array(await (await fetch("/huge.svg")).arrayBuffer());
...
describe("compressText (browser) – 2 KB Markdown", () => {
  bench("quality 1", () => {
...
describe("compressText (browser) – 8 KB HTML", () => {
  bench("quality 1", () => {
...
describe("compress (browser) – 4.9 MB SVG (huge.svg)", () => {
  bench("quality 1", () => {
...
describe("compress (browser) – 2.1 MB PNG (huge.png)", () => {
  bench("quality 1", () => {
