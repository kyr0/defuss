...
export type DropdownMenuSeparatorProps = ElementProps<HTMLHRElement>;
...
export const DropdownMenu: FC<DropdownMenuProps> = ({
  ...
  const dropdownRef = ref || createRef<HTMLDivElement>();
...
export const DropdownMenuHeading: FC<DropdownMenuHeadingProps> = ({
  className,
  children,
  ...props
}) => {
