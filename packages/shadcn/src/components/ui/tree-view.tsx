...
import type { DataviewEntry, DataviewJsonValue, DataviewState } from "defuss-dataview";
...
export type TreeViewProps = ElementProps<HTMLDivElement> & {
	...
	/**
	 * Optional dataview state. When provided, `idField` is derived from
	 * `dataview.tree?.idField ?? dataview.idField` unless explicitly overridden.
	 */
	dataview?: DataviewState;
	/** Field used as the node identifier (must match tree.idField). Overrides `dataview.tree?.idField`. */
	idField?: string;
...
export const TreeView: FC<TreeViewProps> = ({
	...
	// Derive idField from the dataview prop when not explicitly set.
