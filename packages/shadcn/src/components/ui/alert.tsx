...
export const alertVariants = cva("alert w-full relative", {
  variants: {
    variant: {
      default: "",
...
export type AlertProps = ElementProps<HTMLDivElement> &
...
export const Alert: FC<AlertProps> = ({
  ...
  const alertRef = ref || createRef<HTMLDivElement>();
...
export const AlertAction: FC<AlertActionProps> = ({
  ...
  return (
    <footer class={cn("col-start-2 mt-1", className)} {...props}>
      {children}
    </footer>
  );
};
