...
export type ItemProps = ElementProps<HTMLElement> &
...
export const Item: FC<ItemProps> = ({
  ...
  const itemRef = ref || createRef<HTMLElement>();
...
export const ItemLeading: FC<ItemLeadingProps> = ({
  className,
  children,
  ...props
}) => (
  <div
    class={cn("flex shrink-0 items-center justify-center gap-2", className)}
    {...props}
  >
    {children}
  </div>
...
export const ItemTrailing: FC<ItemTrailingProps> = ({
  className,
  children,
  ...props
}) => (
