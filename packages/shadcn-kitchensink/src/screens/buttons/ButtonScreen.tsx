...
export const ButtonScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <CodePreview code={`<Button>Button</Button>`} language="tsx">
      ...
      <section class="prose dark:prose-invert max-w-none">
        <p>
          You can use the <code>Button</code> component or styling classes:
        </p>
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li>
            ...
            <ul class="list-disc pl-6 mt-2">
              <li>
                <code>default</code> (or <code>btn-primary</code>)
              </li>
              <li>
                <code>secondary</code> (or <code>btn-secondary</code>)
              </li>
              <li>
                <code>destructive</code> (or <code>btn-destructive</code>)
              </li>
              <li>
                <code>outline</code> (or <code>btn-outline</code>)
              </li>
              <li>
                <code>ghost</code> (or <code>btn-ghost</code>)
              </li>
              <li>
                <code>link</code> (or <code>btn-link</code>)
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="list-disc pl-6 mt-2">
              <li>
                <code>sm</code> (or <code>btn-sm</code>)
              </li>
              <li>
                <code>lg</code> (or <code>btn-lg</code>)
              </li>
              <li>
                <code>icon</code> (or <code>btn-icon</code>)
              </li>
            </ul>
          </li>
        </ul>
      ...
      <CodeBlock
        code={`import { Button } from "defuss-shadcn"
...
export const MyComponent = () => (
  ...
  Send email
      ...
      <h3
        ...
        class="text-xl font-semibold tracking-tight scroll-m-20"
      >
        <a href="#example-loading">Loading</a>
      </h3>
      <CodePreview
      ...
      >
        <Button variant="outline" disabled>
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-loader-2 mr-2 h-4 w-4 animate-spin"
          >
  ...
  Buy
      ...
      >
        <Button size="lg">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-shopping-cart mr-2 h-5 w-5"
          >
      ...
      <CodePreview
        code={`<Button variant="destructive" size="icon-sm">
  <Trash className="h-4 w-4" />
      ...
      <h3
        ...
        class="text-xl font-semibold tracking-tight scroll-m-20"
      >
        <a href="#example-button-link">Button as link</a>
      </h3>
      <CodePreview
        code={`<a href="#" className="btn inline-flex items-center">
   ...
   Documentation
      ...
      >
        <a href="#" className="btn inline-flex items-center">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-code ml-2 h-4 w-4"
          >
      ...
      <h3
        id="button-with-spinner-only"
        class="text-xl font-semibold tracking-tight scroll-m-20"
      >
        <a href="#button-with-spinner-only">Button with spinner only</a>
      </h3>
      <CodePreview
        code={`<Button size="icon" disabled>
   <Loader2 className="h-4 w-4 animate-spin" />
      ...
      >
        <Button size="icon" disabled>
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-loader-2 h-4 w-4 animate-spin"
          >
            <path d="M21 12a9 9 0 1 1-6.219-8.56" />
          </svg>
        </Button>
      ...
      <h3
        id="example-toggle-button"
        class="text-xl font-semibold tracking-tight scroll-m-20"
      >
        <a href="#example-toggle-button">Toggle Button</a>
      </h3>
  ...
  Toggle me
      ...
      <CodeBlock
        code={`import { ToggleButton } from "defuss-shadcn"
import { useState } from "defuss"
