...
export const CommandScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <CodePreview
        code={`<Command className="w-full max-w-[450px] rounded-lg border shadow-md" aria-label="Command menu">
    <CommandInput placeholder="Type a command or search..." />
    <CommandList>
        <div role="group" aria-labelledby="cmd-suggestions">
            <CommandMenuHeading id="cmd-suggestions">Suggestions</CommandMenuHeading>
            <CommandItem>
                <span>Calendar</span>
            </CommandItem>
            <CommandItem>
        ...
        <div role="group" aria-labelledby="cmd-settings">
            <CommandMenuHeading id="cmd-settings">Settings</CommandMenuHeading>
      ...
      >
        <Command
          className="w-full max-w-[450px] rounded-lg border shadow-md"
        ...
        >
          ...
          <CommandList id="cmd-list">
            <div role="group" aria-labelledby="cmd-suggestions">
              <CommandMenuHeading id="cmd-suggestions">
                Suggestions
              </CommandMenuHeading>
              <CommandItem>
                <span>Calendar</span>
            ...
            <CommandSeparator />
            <div role="group" aria-labelledby="cmd-settings">
              <CommandMenuHeading id="cmd-settings">
                Settings
              </CommandMenuHeading>
              <CommandItem data-filter="Profile">
                <span>Profile</span>
                <Kbd className="ml-auto text-muted-foreground bg-transparent tracking-widest">
                  ⌘P
                </Kbd>
              </CommandItem>
              <CommandItem data-filter="Billing">
