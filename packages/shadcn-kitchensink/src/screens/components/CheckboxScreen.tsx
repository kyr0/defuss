...
export const CheckboxScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <h2 class="text-2xl font-semibold tracking-tight scroll-m-20 pb-2 mt-8">
        Standard Checkbox
      </h2>
      <CodePreview
  ...
  <div className="grid gap-2">
    ...
    <p className="text-muted-foreground text-sm">By clicking this checkbox, you agree to the terms and conditions.</p>
      ...
      >
        <div class="flex items-start gap-3">
          ...
          <div class="grid gap-2">
            <label for="checkbox-with-text" class="label">
      ...
      <CodePreview
        code={`<label className="label gap-3">
  ...
  Accept terms and conditions
      ...
      <CodePreview
        code={`<form className="form flex flex-row items-start gap-3 rounded-md border p-4 shadow-xs">
  ...
  <div className="flex flex-col gap-1">
    ...
    <p className="text-muted-foreground text-sm leading-snug">You can manage your mobile notifications in the mobile settings page.</p>
      ...
      >
        <form class="form flex flex-row items-start gap-3 rounded-md border p-4 shadow-xs">
          ...
          <div class="flex flex-col gap-1">
            <label for="checkbox-form-1" class="leading-snug">
      ...
      <CodePreview
        code={`<form className="form flex flex-col gap-4">
  <header>
