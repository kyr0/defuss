...
<dialog id="dialog-example" className="dialog w-full sm:max-w-[425px] max-h-[612px]" aria-labelledby="dialog-example-title" aria-describedby="dialog-example-description" onClick={(event) => { if (event.target === event.currentTarget) (event.currentTarget as HTMLDialogElement).close(); }}>
  <div>
    <header>
    ...
    <section className="overflow-y-auto scrollbar">
      <div className="space-y-4 text-sm">...</div>
    </section>
    <footer>
      <button className="btn-outline" onClick={(e) => ((e.currentTarget as HTMLElement).closest("dialog") as HTMLDialogElement)?.close()}>Close</button>
    </footer>
    <button type="button" aria-label="Close dialog" onClick={(e) => ((e.currentTarget as HTMLElement).closest("dialog") as HTMLDialogElement)?.close()}>...</button>
  </div>
</dialog>`} language="tsx">
                <div class="space-y-4">
                    ...
                    <dialog id="dialog-example" class="dialog w-full sm:max-w-[425px] max-h-[612px]" aria-labelledby="dialog-example-title" aria-describedby="dialog-example-description" onClick={(event) => { if (event.target === event.currentTarget) (event.currentTarget as HTMLDialogElement).close(); }}>
                        <div>
                            <header>
                                <h2 id="dialog-example-title">Scrollable Content</h2>
                                <p id="dialog-example-description">This is a dialog with scrollable content.</p>
                            ...
                            <footer>
                                <button class="btn-outline" onClick={(e) => ((e.currentTarget as HTMLElement).closest("dialog") as HTMLDialogElement)?.close()}>Close</button>
                            </footer>

                            <button type="button" aria-label="Close dialog" onClick={(e) => ((e.currentTarget as HTMLElement).closest("dialog") as HTMLDialogElement)?.close()}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M18 6 6 18" />
                                    <path d="m6 6 12 12" />
                                </svg>
