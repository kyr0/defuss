...
export const SpinnerScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <CodePreview
        code={`<article className="group/item flex items-center border text-sm rounded-md transition-colors flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] border-transparent bg-muted/50 p-4 gap-4">
      ...
      >
        <article class="group/item flex items-center border text-sm rounded-md transition-colors flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] border-transparent bg-muted/50 p-4 gap-4 w-full max-w-xs">
          ...
          <div class="flex flex-1 flex-col gap-1">
            <h3 class="flex w-fit items-center gap-2 text-sm leading-snug font-medium line-clamp-1">
              Processing payment...
            </h3>
          </div>
    ...
    Loading...
      ...
      <CodePreview
        code={`<Item className="w-full max-w-md" variant="outline">
