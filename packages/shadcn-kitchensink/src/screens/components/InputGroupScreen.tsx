...
export const InputGroupScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <p class="text-lg text-muted-foreground">
        Compose inputs with icons, text, buttons, tooltips and dropdowns.
      </p>
  ...
  <div className="relative">
    ...
    <footer className="absolute bottom-0 px-3 pb-3 pt-1.5 flex items-center w-full gap-2">
        ...
        <div class="grid gap-6 w-full max-w-2xl">
          ...
          <div class="relative">
            ...
            <div
              ...
              class="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground [&>svg]:size-4 cursor-help"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div class="relative">
            <textarea
              class="textarea pr-10 min-h-27 pb-12"
              placeholder="Ask, Search or Chat..."
            ></textarea>
            <footer class="absolute bottom-0 px-3 pb-3 pt-1.5 flex items-center w-full gap-2">
              <button
                type="button"
                class="btn-icon-outline rounded-full size-6 text-muted-foreground hover:text-accent-foreground"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="btn-sm-ghost text-muted-foreground hover:text-accent-foreground h-6 p-2">
                  Auto
                </DropdownMenuTrigger>
                <DropdownMenuContent className="min-w-32" data-side="top">
                  <DropdownMenuItem>Auto</DropdownMenuItem>
              ...
              <button
                type="button"
                class="btn-icon rounded-full size-6 bg-muted-foreground hover:bg-foreground"
                disabled
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <footer className="absolute bottom-0 px-3 pb-3 pt-1.5 flex items-center w-full gap-2">
      ...
      >
        <div class="grid gap-6 w-full max-w-2xl">
          ...
          <div class="relative">
            <textarea
              class="textarea pr-10 min-h-25 pb-12"
      ...
      >
        <div class="grid gap-6 w-full max-w-2xl">
          ...
          <div class="relative">
            ...
            />
            <div
              data-tooltip="Click for help with API keys."
              data-side="left"
              class="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground [&>svg]:size-4 cursor-help"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div class="relative">
            <input
              type="text"
              class="input pl-21 pr-9 rounded-full"
              placeholder="Search secure origin"
            />
            <button
              type="button"
              class="absolute right-1.5 top-1/2 -translate-y-1/2 btn-icon-ghost text-muted-foreground hover:text-accent-foreground size-6 rounded-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <div class="absolute left-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1 z-10">
              ...
              <div class="text-muted-foreground text-sm pointer-events-none">
                https://
              </div>
            </div>
          </div>
