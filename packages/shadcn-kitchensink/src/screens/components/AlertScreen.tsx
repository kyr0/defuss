...
import { Alert, AlertTitle, AlertDescription, AlertAction } from "defuss-shadcn";
...
export const AlertScreen: FC = () => {
    return (
        <div class="space-y-6">
            ...
            <p class="text-lg text-muted-foreground">Displays a callout for user attention.</p>
                        <CodePreview code={`<div className="grid w-full max-w-xl items-start gap-4">
    <Alert>
    ...
    <Alert variant="destructive">
        ...
        <AlertDescription>
            ...
            <CodePreview code={`<div className="alert">
  ...
  <h2>This is a very long alert title that demonstrates how the component handles extended text content and potentially wraps across multiple lines</h2>
            ...
            <CodePreview code={`<div className="alert-destructive">
