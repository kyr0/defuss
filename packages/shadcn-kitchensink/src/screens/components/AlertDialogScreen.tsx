...
export const AlertDialogScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <CodePreview
        code={`<AlertDialogTrigger dialogId="alert-dialog" className="btn-outline">Open alert dialog</AlertDialogTrigger>
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <button className="btn-primary" onClick={() => (document.getElementById("alert-dialog") as HTMLDialogElement)?.close()}>Continue</button>
        ...
        language="tsx"
      >
        <AlertDialogTrigger dialogId="alert-dialog" className="btn-outline">
          Open alert dialog
        </AlertDialogTrigger>
