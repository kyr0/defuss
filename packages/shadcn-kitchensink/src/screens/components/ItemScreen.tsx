  ...
  return (
    <div class="space-y-6">
      ...
      <p class="text-lg text-muted-foreground">
        A versatile content row for lists, cards, and navigation.
      </p>
    ...
    <div className="flex items-center gap-2 [&_svg]:size-4">
      ...
      >
        <div class="flex flex-col gap-6">
          ...
          <a
            href="#"
            class="group/item flex items-center border text-sm rounded-md transition-colors [a]:hover:bg-accent/50 [a]:transition-colors duration-100 flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] border-border py-3 px-4 gap-2.5 w-full max-w-md"
          >
      ...
      <CodePreview
        code={`<Item className="w-full max-w-md" variant="muted">
