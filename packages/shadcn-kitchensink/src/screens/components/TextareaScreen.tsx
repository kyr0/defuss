...
export const TextareaScreen: FC = () => {
  return (
    <div class="space-y-6">
      ...
      <CodePreview
        code={`<div className="relative w-full max-w-2xl">
    ...
    <footer className="absolute bottom-0 flex items-center w-full gap-2 p-3 border-t">
      ...
      >
        <div class="relative w-full max-w-2xl">
          <textarea
            class="textarea pt-15 pb-17 min-h-77 min-w-[300px]"
          ...
          <header class="absolute top-0 flex items-center w-full gap-2 p-3 border-b">
            ...
            <span class="font-mono text-sm text-muted-foreground mr-auto">
              script.js
            </span>
            <button
          ...
          <footer class="absolute bottom-0 flex items-center w-full gap-2 p-3 border-t">
            <span class="text-sm text-muted-foreground mr-auto">
              Line 1, Column 1
            </span>
