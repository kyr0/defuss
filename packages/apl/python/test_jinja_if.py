...
# post: test
{{ set_context('test_string', 'Hello world') }}
{% if "Hello" in get_context('test_string', '') %}
    {{ set_context('condition_met', true) }}
{% else %}
    {{ set_context('condition_met', false) }}
{% endif %}
"""
...
{% if "Test" in result_text %}
    {{ set_context('found_test', true) }}
{% else %}
    {{ set_context('found_test', false) }}
{% endif %}
"""
