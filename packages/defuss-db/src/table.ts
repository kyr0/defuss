import type { DefussProvider } from "./types";

export class DefussTable<T, O> {
  private provider: DefussProvider<O>;
   ...
   */
  async insert(value: T, indexData: Record<string, string | number>): Promise<bigint|number> {
   ...
   */
  async find(indexData: Partial<Record<string, string | number>> = {}): Promise<T[]> {
   ...
   */
  async findOne(indexData: Partial<Record<string, string | number>> = {}): Promise<T | null> {
   ...
   */
  async update(indexData: Partial<Record<string, string | number>>, dataToUpdate: Partial<T>): Promise<void> {
   ...
   * @param indexData - A JSON object representing dynamic indices. All fields are optional.
   */
  async delete(indexData: Partial<Record<string, string | number>>): Promise<void> {
   ...
   */
  async upsert(value: T, indexData: Record<string, string | number>): Promise<number> {
