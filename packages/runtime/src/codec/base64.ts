import { _HEX_PREFIX, hexToBinary } from "./binary.js";
...
export function binaryToBase64(buffer: ArrayBufferLike): string {
...
export function base64ToBinary(base64: string): ArrayBufferLike {
