...
import {createTrans, type TransRef} from "./trans.js";
import {createI18n, type TranslationKeys} from "./i18n.js";
...
describe("Trans component", () => {
	...
	const i18n = createI18n<TranslationKeys<typeof englishTranslations>>();
	...
	beforeEach(() => {
		...
		load("en", englishTranslations);
		load("de", germanTranslations);
		load("es", spanishTranslations);
		changeLanguage("en");
	});
	...
	describe("edge cases", () => {
		...
		it("should handle non-existent translation key", async () => {
			//@ts-expect-error missing key error
...
describe("accessibility and semantic rendering", async () => {
	const englishTranslations = {
		simple: "Simple message",
		longText: "This is a very long message that contains multiple sentences. It should render properly without any issues. The component should handle {param} interpolation even in longer texts seamlessly.",
