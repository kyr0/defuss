...
import { a$, aDequeryChain } from "./dequery_async.js";

describe('Element creation test', async () => {
  it('can create a <div> element with class and id', async () => {
    const d = await a$('<div>', { class: 'boxed task', id: "foo" });
    expect(d).toBeInstanceOf(aDequeryChain); // check that d is an instance of Dequery
  ...
  it('can create a <span> element with a single class', async () => {
    const s = await a$('<span>', { class: 'highlight' });
    expect(s).toBeInstanceOf(aDequeryChain); // check that s is an instance of Dequery
  ...
  it('can create an <input> element with type and placeholder', async () => {
    const input = await a$('<input>', { type: 'text', placeholder: 'Enter text' });
    expect(input).toBeInstanceOf(aDequeryChain); // check that input is an instance of Dequery
  ...
  it('can create a <button> element with html content', async () => {
    const button = await a$('<button>', { html: 'Click me' });
    expect(button).toBeInstanceOf(aDequeryChain); // check that button is an instance of Dequery
  ...
  it('can create a <p> element with multiple attributes', async () => {
    const p = await a$('<p>', { class: 'text', id: 'paragraph', title: 'Paragraph Title' });
    expect(p).toBeInstanceOf(aDequeryChain); // check that p is an instance of Dequery
  ...
  it('can add a mouseover event listener to a <div> element', async () => {
    const div = await a$('<div>', { class: 'hoverable' });
    let hovered = false;
  ...
  it('can create a <div> element with text content', async () => {
    const div = await a$('<div>', { text: 'Hello World' });
    expect(div).toBeInstanceOf(aDequeryChain); // check that div is an instance of Dequery
  ...
  it('can append a <span> element to a <div> element', async () => {
    const div = await a$('<div>', { text: 'Parent' });
    const span = await a$('<span>', { text: 'Child' });
  ...
  it('does not append when the parameter is null', async () => {
    const div = await a$('<div>Parent</div>');
  ...
  it('can access elements using array-like indexing', async () => {
    const div = await a$('<div>Parent</div>', { text: 'Parent' });
    const span1 = await a$('<span>Child 1</span>', { text: 'Child 1' });
    const span2 = await a$('<span>Child 2</span>', { text: 'Child 2' });
  ...
  it('can create a form with values and then set it', async () => {
    const form = await a$('<form>');
    const input1 = await a$('<input>', { name: 'username' });
    const input2 = await a$('<input>', { name: 'password' });
