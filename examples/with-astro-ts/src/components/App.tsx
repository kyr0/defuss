  ...
  return (
    <div>
      <a href="https://vite.dev" target="_blank" rel="noreferrer">
        <svg width="85" height="107" viewBox="0 0 85 107" class="logo" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="https://www.typescriptlang.org/" target="_blank" rel="noreferrer">
        <img src={typescriptLogo.src} class="logo vanilla" alt="TypeScript logo" />
      </a>
