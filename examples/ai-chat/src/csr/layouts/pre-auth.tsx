      ...
      <div class="grid h-svh overflow-hidden lg:grid-cols-2">
        ...
        <div class="relative hidden overflow-hidden lg:block">
          ...
          <div class="pre-auth-content relative flex h-full flex-col items-center justify-center gap-8 p-12 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="drop-shadow-2xl"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
            <blockquote class="max-w-md text-center">
              <p class="text-lg font-medium leading-relaxed text-white/90">{t("pre_auth.tagline")}</p>
