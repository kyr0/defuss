 ...
 */
// Module-level AbortController for canceling active inference
let activeAbortController: AbortController | null = null;

export class ChatApi {
	/**
	 * Cancel the currently active streaming inference on the server side.
	 */
	async cancelInference(): Promise<boolean> {
