...
export function RightSidebar() {
	...
	return (
		<div ref={containerRef} class="chat-sidebar-right flex flex-col h-full border-l bg-sidebar text-sidebar-foreground">
			<div class="flex items-center px-3 py-3 border-b">
			...
			<div class="sidebar-content flex-1 overflow-y-auto p-3 scrollbar">
				<form ref={formRef} class="grid gap-4" onChange={saveSettings}>
					...
					<div class="grid gap-1.5">
						...
						<input id="temperature" name="temperature" type="range" min="0" max="1" step="0.05" value={String(s.temperature)} class="w-full accent-primary" onInput={onSliderInput} />
					</div>
					...
					<div class="grid gap-1.5">
						...
						<input id="topP" name="topP" type="range" min="0.85" max="0.95" step="0.05" value={String(s.topP)} class="w-full accent-primary" onInput={onSliderInput} />
					</div>
					...
					<div class="grid gap-1.5">
						...
						<Input id="repetitionPenalty" name="repetitionPenalty" type="number" value={String(s.repetitionPenalty)} className="h-8 text-xs" min="0" step="0.1" />
					</div>
					...
					<div class="grid gap-1.5">
						...
						<input id="presencePenalty" name="presencePenalty" type="range" min="0" max="2" step="0.1" value={String(s.presencePenalty)} class="w-full accent-primary" onInput={onSliderInput} />
					</div>
				</form>
			</div>
		</div>
