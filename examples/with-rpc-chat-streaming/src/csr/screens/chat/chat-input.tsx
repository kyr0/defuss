...
import { setStreamRendering } from "./message-list";
import { t } from "../../i18n";
...
export function ChatInput() {
	...
	return (
		<div class="chat-input-area border-t bg-background px-4 py-3">
			<div class="max-w-3xl mx-auto flex items-end gap-2">
				<textarea
					ref={textareaRef}
					class="textarea flex-1 min-h-[44px] max-h-[200px] resize-none text-sm py-3 px-4"
