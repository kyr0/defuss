...
} from "@ionic/core/components/custom-elements.d.ts";
...
declare namespace LocalJSX {
  ...
  interface IonIcon {
    /**
      * Specifies the icon to use. The icon can be an SVG or a web font.
     */
    "icon"?: string;
    /**
      * If `true`, the icon will be hidden from screen readers.
     */
    "aria-hidden"?: boolean;
    /**
      * The slot attribute specifies where the icon should be placed in relation to its surrounding content.
     */
    "slot"?: 'start' | 'end' | 'icon-only';
    /**
      * The icon to use for iOS devices.
     */
    "ios"?: string;
    /**
      * The icon to use for Material Design devices.
     */
    "md"?: string;
  }
